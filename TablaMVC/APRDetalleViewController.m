...
{
    [super viewDidLoad];
    self.title = self.contacto.nombre;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        case 0:
            cell.textLabel.text = self.contacto.nombre;
            break;
        case 1:
            cell.textLabel.text = self.contacto.email;
            break;
        case 2:
            cell.textLabel.text = self.contacto.telefono;
            break;
        default:
            break;
    }
